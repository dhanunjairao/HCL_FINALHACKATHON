...
import com.example.HCL_FInal.dto.UserDtos.*;
import com.example.HCL_FInal.enums.Role;
import com.example.HCL_FInal.service.UserService;
...
public class UserController {
    ...
    @Operation(summary = "Create a user account of any role (including ADMIN). Admin only — this is the only way to create admins.")
    @PostMapping
